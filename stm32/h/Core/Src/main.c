...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
    lcd_init ();
    lcd_put_cur(0, 1);
    lcd_send_string ("Namaste..");

    lcd_put_cur(1, 0);
    lcd_send_string ("From Surya");
    ...
    /* USER CODE BEGIN 3 */
	  HAL_ADC_Start(&hadc1);
	       if (HAL_ADC_PollForConversion(&hadc1, HAL_MAX_DELAY) == HAL_OK)
	       {
	           ...
	           sprintf(uartBuffer, "Temp: %.1f%cC", temperature, 176);
	           //sprintf(uartBuffer, "Temp: %.1f%cC", temperature, 248);
	       ...
	       //lcd_clear();
	       lcd_put_cur(0, 1);
	       lcd_send_string("Live temperature");
	       lcd_put_cur(1, 0);
	       lcd_send_string(uartBuffer);
//	       lcd_put_cur(1, 1);
//	       lcd_send_string("surya");
	       HAL_Delay(1000);
